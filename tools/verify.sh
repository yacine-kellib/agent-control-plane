...
run attack_registry.py      "75/75"      "ALL attacks (consolidated registry)"
run attack_registry.py      "4/4"        "Composition ack x ledger" --compose
run conformance.py          "46/46"      "Suite 1  conformance"
run mutate_executor.py      "21/21"      "Suite 2  executor mutation"
