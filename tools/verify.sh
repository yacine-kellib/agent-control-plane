...
run attack_registry.py      "83/83"      "ALL attacks (consolidated registry)"
run attack_registry.py      "4/4"        "Composition ack x ledger" --compose
run conformance.py          "54/54"      "Suite 1  conformance"
run mutate_executor.py      "27/27"      "Suite 2  executor mutation"
