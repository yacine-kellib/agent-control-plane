...
run attack_registry.py      "76/76"      "ALL attacks (consolidated registry)"
run attack_registry.py      "4/4"        "Composition ack x ledger" --compose
run conformance.py          "47/47"      "Suite 1  conformance"
run mutate_executor.py      "22/22"      "Suite 2  executor mutation"
