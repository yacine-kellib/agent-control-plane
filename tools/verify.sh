...
run attack_registry.py      "77/77"      "ALL attacks (consolidated registry)"
run attack_registry.py      "4/4"        "Composition ack x ledger" --compose
run conformance.py          "48/48"      "Suite 1  conformance"
run mutate_executor.py      "23/23"      "Suite 2  executor mutation"
