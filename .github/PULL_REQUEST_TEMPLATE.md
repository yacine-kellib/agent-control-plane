...
- [ ] `./tools/selftest.sh` passes (121 assertions) — required if you touched anything in `tools/`
...
- [ ] I did not copy `reference/src/*.py`. Those modules carry mutation markers that 38 mutants locate by reading the source text — a fork voids that evidence silently. Subclass and extend instead.
