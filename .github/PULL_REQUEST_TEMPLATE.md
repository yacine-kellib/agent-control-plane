...
- [ ] I did not copy `reference/src/*.py`. Those modules carry mutation markers that 30 mutants locate by reading the source text — a fork voids that evidence silently. Subclass and extend instead.
