...
```
== 1. Integrity ==
  OK   140 files match MANIFEST.sha256
...
`MANIFEST.sha256` covers 140 files across ten signed roots and is signed with an offline Ed25519 key.
...
./tools/selftest.sh               # tests the tooling itself (46 assertions)
```
