...
```
== 1. Integrity ==
  OK   137 files match MANIFEST.sha256
...
```bash
cargo check --workspace && cargo test --workspace   # Rust: 127 tests
...
`MANIFEST.sha256` covers 137 files across 8 signed roots and is signed with an offline Ed25519 key.
